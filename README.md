...
- [@lifehackerhansol](https://github.com/lifehackerhansol)# Pico Launcher
이 저장소는 [Pico Loader](https://github.com/LNH-team/pico-loader)의 프런트엔드인 Pico Launcher를 포함하고 있습니다. 비공식 한글, 일본어 패치가 적용되어 있습니다.
...
> [!NOTE]
> Pico Launcher를 사용하려면 Pico Loader 파일들(`aplist.bin`, `savelist.bin`, `picoLoader7.bin`, `picoLoader9.bin`)이 SD 카드의 `/_pico` 폴더 내에 반드시 존재해야 합니다.
