...
bool RomBrowserStateMachine::FireDirect(RomBrowserStateTrigger trigger)
{
    ...
    if (StateMachineTriggerChecker(_curState, trigger)
        ...
        .In(RomBrowserState::Browser)
            ...
            .Trigger(RomBrowserStateTrigger::ShowLaunchSettings).GoesTo(RomBrowserState::ShowLaunchSettings)
        ...
        .In(RomBrowserState::ShowLaunchSettings)
            .Trigger(RomBrowserStateTrigger::HideLaunchSettings).GoesTo(RomBrowserState::Browser)
        .Check(newState))
    {
